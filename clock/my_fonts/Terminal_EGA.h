...
const uint8_t TerminalRegularRNormal81209672C80IBMCP437Bitmap[] PROGMEM = {	
	...
	0x00,0x00,0x00,0x00,0x00,0x70,0x30,0x60,	/* 0x2C comma ',' */
	...
	0x78,0xCC,0xDC,0xFC,0xEC,0xCC,0x78,0x00,	/* 0x30 zero '0' */
	0x30,0xF0,0x30,0x30,0x30,0x30,0xFC,0x00,	/* 0x31 one '1' */
	0x78,0xCC,0x0C,0x38,0x60,0xCC,0xFC,0x00,	/* 0x32 two '2' */
	0x78,0xCC,0x0C,0x38,0x0C,0xCC,0x78,0x00,	/* 0x33 three '3' */
	0x1C,0x3C,0x6C,0xCC,0xFE,0x0C,0x0C,0x00,	/* 0x34 four '4' */
	0xFC,0xC0,0xF8,0x0C,0x0C,0xCC,0x78,0x00,	/* 0x35 five '5' */
	0x38,0x60,0xC0,0xF8,0xCC,0xCC,0x78,0x00,	/* 0x36 six '6' */
	0xFC,0xCC,0x0C,0x18,0x30,0x60,0x60,0x00,	/* 0x37 seven '7' */
	0x78,0xCC,0xCC,0x78,0xCC,0xCC,0x78,0x00,	/* 0x38 eight '8' */
	0x78,0xCC,0xCC,0x7C,0x0C,0x18,0x70,0x00,	/* 0x39 nine '9' */
	0x00,0x00,0x30,0x30,0x00,0x30,0x30,0x00,	/* 0x3A colon ':' */
	0x00,0x00,0x30,0x30,0x00,0x70,0x30,0x60,	/* 0x3B semicolon ';' */
	0x18,0x30,0x60,0xC0,0x60,0x30,0x18,0x00,	/* 0x3C less '<' */
	0x00,0x00,0xFC,0x00,0xFC,0x00,0x00,0x00,	/* 0x3D equal '=' */
	...
	0x30,0x78,0xCC,0xCC,0xFC,0xCC,0xCC,0x00,	/* 0x41 A 'A' */
	0xFC,0x66,0x66,0x7C,0x66,0x66,0xFC,0x00,	/* 0x42 B 'B' */
	0x3C,0x66,0xC0,0xC0,0xC0,0x66,0x3C,0x00,	/* 0x43 C 'C' */
	0xFC,0x6C,0x66,0x66,0x66,0x6C,0xFC,0x00,	/* 0x44 D 'D' */
	0xFE,0x62,0x68,0x78,0x68,0x62,0xFE,0x00,	/* 0x45 E 'E' */
	0xFE,0x62,0x68,0x78,0x68,0x60,0xF0,0x00,	/* 0x46 F 'F' */
	0x3C,0x66,0xC0,0xC0,0xCE,0x66,0x3E,0x00,	/* 0x47 G 'G' */
	0xCC,0xCC,0xCC,0xFC,0xCC,0xCC,0xCC,0x00,	/* 0x48 H 'H' */
	0x78,0x30,0x30,0x30,0x30,0x30,0x78,0x00,	/* 0x49 I 'I' */
	0x1E,0x0C,0x0C,0x0C,0xCC,0xCC,0x78,0x00,	/* 0x4A J 'J' */
	0xE6,0x66,0x6C,0x78,0x6C,0x66,0xE6,0x00,	/* 0x4B K 'K' */
	0xF0,0x60,0x60,0x60,0x62,0x66,0xFE,0x00,	/* 0x4C L 'L' */
	0xC6,0xEE,0xFE,0xD6,0xC6,0xC6,0xC6,0x00,	/* 0x4D M 'M' */
	0xC6,0xE6,0xF6,0xDE,0xCE,0xC6,0xC6,0x00,	/* 0x4E N 'N' */
	0x38,0x6C,0xC6,0xC6,0xC6,0x6C,0x38,0x00,	/* 0x4F O 'O' */
	0xFC,0x66,0x66,0x7C,0x60,0x60,0xF0,0x00,	/* 0x50 P 'P' */
	0x78,0xCC,0xCC,0xCC,0xDC,0x78,0x1C,0x00,	/* 0x51 Q 'Q' */
	0xFC,0x66,0x66,0x7C,0x78,0x6C,0xE6,0x00,	/* 0x52 R 'R' */
	0x78,0xCC,0xE0,0x38,0x1C,0xCC,0x78,0x00,	/* 0x53 S 'S' */
	0xFC,0xB4,0x30,0x30,0x30,0x30,0x78,0x00,	/* 0x54 T 'T' */
	0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xFC,0x00,	/* 0x55 U 'U' */
	0xCC,0xCC,0xCC,0xCC,0xCC,0x78,0x30,0x00,	/* 0x56 V 'V' */
	0xC6,0xC6,0xC6,0xD6,0xFE,0xEE,0xC6,0x00,	/* 0x57 W 'W' */
	0xC6,0xC6,0x6C,0x38,0x6C,0xC6,0xC6,0x00,	/* 0x58 X 'X' */
	0xCC,0xCC,0xCC,0x78,0x30,0x30,0x78,0x00,	/* 0x59 Y 'Y' */
	0xFE,0xCC,0x98,0x30,0x62,0xC6,0xFE,0x00,	/* 0x5A Z 'Z' */
	...
	0x00,0x00,0x78,0x0C,0x7C,0xCC,0x76,0x00,	/* 0x61 a 'a' */
	0xE0,0x60,0x7C,0x66,0x66,0x66,0xBC,0x00,	/* 0x62 b 'b' */
	0x00,0x00,0x78,0xCC,0xC0,0xCC,0x78,0x00,	/* 0x63 c 'c' */
	0x1C,0x0C,0x0C,0x7C,0xCC,0xCC,0x76,0x00,	/* 0x64 d 'd' */
	0x00,0x00,0x78,0xCC,0xFC,0xC0,0x78,0x00,	/* 0x65 e 'e' */
	0x38,0x6C,0x60,0xF0,0x60,0x60,0xF0,0x00,	/* 0x66 f 'f' */
	0x00,0x00,0x76,0xCC,0xCC,0x7C,0x0C,0xF8,	/* 0x67 g 'g' */
	0xE0,0x60,0x6C,0x76,0x66,0x66,0xE6,0x00,	/* 0x68 h 'h' */
	0x30,0x00,0x70,0x30,0x30,0x30,0x78,0x00,	/* 0x69 i 'i' */
	0x18,0x00,0x78,0x18,0x18,0x18,0xD8,0x70,	/* 0x6A j 'j' */
	0xE0,0x60,0x66,0x6C,0x78,0x6C,0xE6,0x00,	/* 0x6B k 'k' */
	0x70,0x30,0x30,0x30,0x30,0x30,0x78,0x00,	/* 0x6C l 'l' */
	0x00,0x00,0xEC,0xFE,0xD6,0xC6,0xC6,0x00,	/* 0x6D m 'm' */
	0x00,0x00,0xF8,0xCC,0xCC,0xCC,0xCC,0x00,	/* 0x6E n 'n' */
	0x00,0x00,0x78,0xCC,0xCC,0xCC,0x78,0x00,	/* 0x6F o 'o' */
	0x00,0x00,0xDC,0x66,0x66,0x7C,0x60,0xF0,	/* 0x70 p 'p' */
	0x00,0x00,0x76,0xCC,0xCC,0x7C,0x0C,0x1E,	/* 0x71 q 'q' */
	0x00,0x00,0xD8,0x6C,0x6C,0x60,0xF0,0x00,	/* 0x72 r 'r' */
	0x00,0x00,0x7C,0xC0,0x78,0x0C,0xF8,0x00,	/* 0x73 s 's' */
	0x10,0x30,0x7C,0x30,0x30,0x34,0x18,0x00,	/* 0x74 t 't' */
	0x00,0x00,0xCC,0xCC,0xCC,0xCC,0x76,0x00,	/* 0x75 u 'u' */
	0x00,0x00,0xCC,0xCC,0xCC,0x78,0x30,0x00,	/* 0x76 v 'v' */
	0x00,0x00,0xC6,0xC6,0xD6,0xFE,0x6C,0x00,	/* 0x77 w 'w' */
	0x00,0x00,0xC6,0x6C,0x38,0x6C,0xC6,0x00,	/* 0x78 x 'x' */
	0x00,0x00,0xCC,0xCC,0xCC,0x7C,0x0C,0xF8,	/* 0x79 y 'y' */
	0x00,0x00,0xFC,0x98,0x30,0x64,0xFC,0x00,	/* 0x7A z 'z' */
	...
	0x10,0x38,0x6C,0xC6,0xC6,0xC6,0xFE,0x00,	/* 0x7F house '' */
};


const GFXglyph TerminalRegularRNormal81209672C80IBMCP437Glyph[] PROGMEM = {
...
/* offset, bit-width, bit-height, advance cursor, x offset, y offset */
	...
	{ 760, 8, 8, 8, 1, 0 }, /* 0x7F house '' */
};


const GFXfont TerminalRegularRNormal81209672C80IBMCP437 PROGMEM = {
	(uint8_t *)TerminalRegularRNormal81209672C80IBMCP437Bitmap,
	(GFXglyph *)TerminalRegularRNormal81209672C80IBMCP437Glyph, 
